...
int main() {
    ...
    graph.setVertexValue(0, "A");
    graph.setVertexValue(1, "B");
    graph.setVertexValue(2, "C");
    graph.setVertexValue(3, "D");
    graph.setVertexValue(4, "E");
    graph.setVertexValue(5, "F");
    graph.setVertexValue(6, "G");
